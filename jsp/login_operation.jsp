...
<style type="text/css">
.index {
	background: url(../../html/login/skin/loginBackGround_operation.jpg)
...
.logo-operation {
	height: 10%;
	background: url(../../html/login/skin/logo_operation.png) center center
		no-repeat;
...
<body style="min-width: 1024px; overflow: hidden;" scroll="no" class="index">
	<div class="home-content">
		<div id="contenter">
			<div class="logo-operation col-md-8 col-sm-10 col-xs-10 col-md-offset-2 col-sm-offset-1 col-xs-offset-1"></div>
			<div class="login-box login-form">
				<form id="loginform" method="post">
					<input type="hidden" name="loginResult" value="login_operation" />
					<div class="login_form">
						<ul class="clearfix login_ul">
							...
							<li class="login_li"><input tabindex="3" type="text" placeholder="企业代码" name="companyNo" id="companyNo" value="A009"
